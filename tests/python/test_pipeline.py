...
class PipelineTests(unittest.TestCase):
    ...
    def test_indiana_enr_county_json_parser_builds_county_rows(self):
        ...
        self.assertEqual(len(artifact["sources"]), 8)
    ...
    def test_nevada_statewide_results_parser_builds_county_rows(self):
        ...
        self.assertEqual(artifact["native"]["metrics"]["nativeReviewRows"], 1036)
        self.assertEqual(artifact["native"]["metrics"]["nativeComparisonRows"], 1036)
        self.assertEqual(artifact["native"]["metrics"]["nativeComparisonContest"], "United States Senator")
        self.assertIn("Clark County and Washoe County official CVR precinct rows", artifact["native"]["metrics"]["nativeReviewSourceCoverage"])
