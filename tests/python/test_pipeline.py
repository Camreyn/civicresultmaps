...
class PipelineTests(unittest.TestCase):
    ...
    def test_indiana_enr_county_json_parser_builds_county_rows(self):
        ...
        self.assertEqual(len(artifact["sources"]), 11)
        ...
        self.assertTrue(artifact["capabilities"]["historicalBaseline"])
        self.assertEqual(artifact["native"]["metrics"]["nativeHistoricalRows"], 184)
        self.assertEqual(artifact["native"]["metrics"]["nativeHistoricalYears"], [2016, 2020])
        self.assertIn("2012 remains a request/follow-up gap", artifact["native"]["metrics"]["nativeHistoricalWarning"])
