...
test("review center exposes evidence readiness and flag explainability tools", () => {
  ...
  assert.match(tabs, /GraphReadinessStatus/);
  assert.match(tabs, /Ready/);
  assert.match(tabs, /Partial/);
  assert.match(tabs, /Proxy/);
  assert.match(tabs, /Blocked/);
  assert.match(tabs, /Blocking reason/);
  assert.match(tabs, /What source would improve this\?/);
  assert.match(tabs, /buildFlagExplanation/);
  assert.match(tabs, /source context/);
  assert.match(tabs, /Why it appeared/);
  assert.match(tabs, /Formula \/ threshold/);
  assert.match(tabs, /Normal explanations to check/);
  assert.match(tabs, /Missing evidence/);
  assert.match(tabs, /Next review action/);
...
test("guided tour includes evidence review toolkit steps", () => {
  ...
  assert.match(tabs, /id: "guided-workflows"/);
  assert.match(tabs, /id: "export-review-packet"/);
  assert.match(tabs, /target: "\[data-tour='guided-workflows'\]"/);
  assert.match(tabs, /target: "\[data-tour='export-review-packet'\]"/);
