...
function manifest() {
  return {
    ...
    delivery: {
      ...
      url: "/data/geography/wi/2024-11-05/local_reporting_unit/candidate/index.json",
      sha256: "1".repeat(64),
      byteCount: 123,
...
function metadata(value) {
  ...
  return {
    ...
    releaseCandidate: { id: "wi-local-reporting-gis-three-election-v1", sha256: releaseSha256, publicDeliveryAuthorized: true },
    publicActivation: {
      activationId: "wi-public-2024",
...
test("Wisconsin local reporting unit results and geometry use the guarded publication path", () => {
  ...
  assert.deepEqual(guardedLocalGeographyMatchMethods("WI"), [
    "exact_official_id",
    "official_crosswalk",
    "reviewed_name",
    "spatial_review",
...
test("Minnesota rehearsal cannot bypass the Wisconsin publication gate", () => {
