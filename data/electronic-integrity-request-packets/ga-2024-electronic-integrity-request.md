# Georgia 2024 Electronic Integrity Records Request
...
- Logic and accuracy records: status=needs_data; grain=test_deck_or_testing_jurisdiction; reconciliation=not_inventoried. Suggested custodian/path: Georgia county election offices or Secretary of State open records request path.
- Audit results: status=needs_data; grain=audit_unit; reconciliation=not_inventoried. Suggested custodian/path: Georgia county election offices or Secretary of State open records request path.
- Chain of custody: status=needs_data; grain=ballot_equipment_media; reconciliation=not_inventoried. Suggested custodian/path: Georgia county election offices or Secretary of State open records request path.
