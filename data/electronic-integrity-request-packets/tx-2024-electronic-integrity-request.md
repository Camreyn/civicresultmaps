# Texas 2024 Electronic Integrity Records Request
...
- Logic and accuracy records: status=needs_data; grain=test_deck_or_testing_jurisdiction; reconciliation=not_inventoried. Suggested custodian/path: Texas Secretary of State Elections Division, county election officials, or local election authorities depending on record custody.
- Audit results: status=partial; grain=selected_county_state_audit; reconciliation=selected_counties_public_audit_program_context_loaded_no_unit_workpapers. Suggested custodian/path: Texas Secretary of State Elections Division, county election officials, or local election authorities depending on record custody.
- Chain of custody: status=needs_data; grain=ballot_equipment_media; reconciliation=not_inventoried. Suggested custodian/path: Texas Secretary of State Elections Division, county election officials, or local election authorities depending on record custody.
