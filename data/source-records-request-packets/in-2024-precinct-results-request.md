...
- Indiana Election Division President source: `data/in-2024-official-results/OffCatC_1019_A.json`, 92 county rows, 2,936,677 votes. Caveat: Archived official ENR category JSON contains county RegionSummary rows, not precinct/subcounty candidate rows.
- Indiana Election Division U.S. Senate source: `data/in-2024-official-results/OffCatC_1006_A.json`, 92 county rows. Caveat: Supports county-level President-versus-U.S. Senate comparison only.
- Indiana Election Division JurR inventory: `data/in-2024-enr-jurisdiction-reports`, 92 county files. Caveat: Collected JurR files do not contain President or U.S. Senate candidate result rows and are not advisory flag inputs.
- Public ENR app scan: `data/in-2024-official-enr-public-data-inventory.json` reports 92 President county/locality regions, 92 U.S. Senate county/locality regions, 0 JurR candidate containers, and no public same-grain subcounty President/Senate candidate export.
- Live ENR public-path recheck (2026-07-04): ordinary public HTTPS GET requests returned HTTP 200 for 4 documented archive endpoints, including settings, President, U.S. Senate, and statewide turnout JSON. Caveat: The ordinary public archive paths are reachable, but the checked ENR data family still exposes county-level President and U.S. Senate candidate rows plus turnout/statistics data, not a same-grain precinct/subcounty President and U.S. Senate export.
- Indiana Election Division county turnout source: `data/in-2024-general-turnout.csv; data/in-2024-general-turnout-report.pdf`, 92 county rows, 2,976,599 voters voting, and 4,837,802 registered voters. Caveat: County turnout denominator, not precinct turnout denominator.
- VSTOP audit summary source: `data/in-2024-general-post-election-audit-summary-report.pdf; data/in-2024-general-post-election-audit-summary.csv; data/in-2024-general-post-election-audit-summary.json`, 7 county audit-summary context rows. Caveat: Official VSTOP audit summary context only; rows cover seven voluntarily audited counties and selected contests.
...
- The Indiana Election Division Census Data, Statistics and Maps page links the statewide county precinct-count PDF. The routing summary generated from that PDF reports 5,147 precincts, 1,342 precinct splits, and 1,092 precincts with splits. Any result export should therefore identify whether rows are precincts, precinct splits, vote-center/reporting units, absentee/early/provisional units, or county summaries, and should include split identifiers where applicable.
...
- Request matrix: `data/in-2024-source-request-matrix.tsv`
- County routing CSV: `data/in-2024-county-request-routing.csv`
- County routing summary: `data/in-2024-county-request-routing-summary.json`
