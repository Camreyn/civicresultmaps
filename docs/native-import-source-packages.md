...
- Current status: certified county rows, official-source local review, and official active-voter turnout are loaded, but SD remains in `sourceDiscoveryQueue` rather than `completedNativeStates`
