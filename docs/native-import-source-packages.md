...
- Official archive/export evidence: `data/sd-2024-official-results-archive-evidence.json` and `data/sd-2024-general-statewide-results.xlsx`, generated by `scripts/collect-sd-official-archive-evidence.mjs`, identify official SD SOS archive ElectionID 684, candidate-list IDs 19833/19835, map RaceIDs 12665/11954, a 66-county turnout lead, and the official ResultsExport statewide XLSX workbook
