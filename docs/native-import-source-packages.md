...
Expected validation: 17 county result rows, 17 county geometry features, 1,484,840 presidential votes, 1,057 local review rows from Clark/Washoe/Humboldt CVR precinct aggregates, 17 EAC fallback turnout rows, and 51 secondary historical baseline rows. Wave 24 rechecked Eureka County first; the official page exposes current/downloadable 2026 election documents and a Silver State results link but no county-hosted parser-ready 2024 President plus U.S. Senate local export, SOV workbook, or CVR export. Remaining risks: 14 Nevada jurisdictions still need official local President and U.S. Senate rows or CVR/SOV exports, state-native turnout denominators, precinct/local geometry or crosswalks, official 2012/2016/2020 historical replacement artifacts, and normalized audit/CVR/L&A/tabulator-log/custody/incident/correction/recount/litigation records. Current advisory rows are public-interest screening inputs only, not findings.
