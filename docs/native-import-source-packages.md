...
- Turnout source: EAC 2024 county fallback rows, with `data/ne-2024-general-canvass-book.pdf` and `data/ne-2024-post-general-eligible-voter-report.pdf` retained as state-native canvass/registration cross-checks
