...
- Historical advisory source: `data/nc-2020-historical-review-rows.csv`, generated by `scripts/normalize-nc-historical-review.mjs` from the official NCSBE 2020 general precinct results ZIP; 2,662 `Real Precinct=Y` President-versus-U.S.-Senate rows resolve across 100 canonical county tags
- Historical advisory exclusion: the same normalizer inspects `data/nc-2016-results-precinct.zip` and records 2016 as not evaluated because the official export predates the `Real Precinct` field; administrative reporting units are not inferred from labels
