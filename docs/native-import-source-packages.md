...
- Official archive evidence: `data/sd-2024-official-results-archive-evidence.json`, generated by `scripts/collect-sd-official-archive-evidence.mjs`, identifies official SD SOS archive ElectionID 684, candidate-list IDs 19833/19835, map RaceIDs 12665/11954, and a 66-county turnout lead
...
Caveats: the 2024 President and U.S. House rows remain secondary staging rows, not retained certified SOS artifacts. Wave 22 identified official SD SOS archive ElectionID 684 and retained map-data evidence, but the archive totals are 428,728 President votes and 421,264 U.S. House votes, below the current certified-style staging totals by 194 and 184 votes. The official SD SOS 2024 General Election Canvass and Certificate PDF/static export or another reconciling official archive/export remains a P0 request item. Review rows are county-level President-versus-at-large-U.S.-House comparisons, not precinct scatter plots. EAC turnout remains active until state-native turnout/registration denominator rows are reconciled; the ElectionID 684 turnout archive is only a lead. No normalized audit, CVR availability, recount, incident, correction, or litigation rows are loaded.
