...
## Alaska Wave 21 Update

Alaska still uses official EAC 2024 V2 statewide/jurisdiction fallback turnout rows at `data/eac-2024-state-turnout/ak-2024-eac-turnout.csv`, totaling 1 row, 340,981 ballots cast, and 611,078 registered voters. Wave 21 added `data/ak-2024-official-results-page-evidence.json`, confirming the official 2024 General All Details/SOVC follow-up path while preserving the blocker: no lower-grain Alaska-native turnout denominator artifact is loaded. Keep EAC fallback active until official lower-grain turnout/registration rows are collected and reconciled. Follow-up fields are tracked in `data/ak-2024-data-coverage-inventory.json` and `data/ak-2024-source-request-matrix.tsv`.
