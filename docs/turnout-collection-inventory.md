...
- States checked: 50
- Turnout loaded in database or validated native staging: 14`r`n- Loaded through official EAC fallback while state-native denominator remains missing: 2`r`n- Need native turnout package: 36
