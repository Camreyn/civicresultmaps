...
export function buildMinnesotaPrecinctReleaseCandidate(options = {}) {
  ...
  const packageDocument = {
    ...
    goNoGoGates: [
      ...
      { id: "clean_isolated_release_diff", status: "pending", evidence: "Machine classifications are reproducible, but the project owner must confirm them and apply the reviewed projections/hunks in a clean integration worktree." },
      ...
      { id: "reviewed_production_transaction_path", status: "pending", evidence: "The separately guarded implementation exists and is local-testable; project-owner review under the declared human-control mode plus current preflight/backup evidence are still required before use." },
